...
class FavouriteAdapterAll(
    private val context: Context,
    videoList: ArrayList<Video>,
    private var isFolder: Boolean = false,
) : RecyclerView.Adapter<FavouriteAdapterAll.MyHolder>() {
    ...
    class MyHolder(binding: FvItemAllBinding) : RecyclerView.ViewHolder(binding.root) {
...
//        val menu = binding.menu
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(FvItemAllBinding.inflate(LayoutInflater.from(context), parent, false))
    }
