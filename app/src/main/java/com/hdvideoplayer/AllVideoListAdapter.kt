...
class AllVideoListAdapter(
...
) : RecyclerView.Adapter<AllVideoListAdapter.MyHolder>() {
    ...
    class MyHolder(binding: AvListvItemBinding) : RecyclerView.ViewHolder(binding.root) {
...
//        val folder = binding.folderName
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(AvListvItemBinding.inflate(LayoutInflater.from(context), parent, false))
    }
