...
class AllVideoGridAdapter(
    ...
    class MyHolder(binding: AvGridvItemBinding) : RecyclerView.ViewHolder(binding.root) {
...
//        val size = binding.size
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(AvGridvItemBinding.inflate(LayoutInflater.from(context), parent, false))
    }
